...
//
//import static test.LoginTest.email;
//
//public class Login {
//    public static String SuperAdminEmail;
//    private static String SuperAdmin_appPassword;
//
...
//            properties.load(fis);
//            SuperAdminEmail = properties.getProperty("SuperAdminEmail");
//            SuperAdmin_appPassword = properties.getProperty("superAdim_app_password");
//        } catch (IOException e) {
...
//                List<String> emails = Collections.singletonList(MagicLinkmethod.fetchTokenFromEmail(SuperAdminEmail, SuperAdmin_appPassword));
//                System.out.println("Retrieved Emails: " + emails);
//
//                magicLink = MagicLinkmethod.fetchTokenFromEmail(SuperAdminEmail, SuperAdmin_appPassword);
