package SuperAdminLogin;

import WebAdminLoginTest.LoginPayload;
import WebAdminLoginTest.LoginEndpoint;
...
public class SuperAdminLogin {
    ...
    private void loadConfig() {
        ...
        try (FileInputStream fis = new FileInputStream("config.properties")) {
            properties.load(fis);
            email = properties.getProperty("superAdmin_email");
            appPassword = properties.getProperty("superAdmin_app_password");
        } catch (IOException e) {
