...
public class OpportunityDataProvider {
    ...
    @DataProvider(name = "opportunityDataProvider")
    public static Object[][] provideOpportunityData() {
        ...
        formData.put("title", "Test automation opportunity");
        formData.put("description", "Test automation opportunity description for all");
